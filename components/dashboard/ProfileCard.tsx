...
import { Heart, X, Eye, MapPin, CheckCircle, GraduationCap, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      {swipeDirection === 'right' && (
        <div className="absolute top-8 right-8 z-20 bg-green-500 text-white px-6 py-3 rounded-xl font-bold text-lg shadow-xl flex items-center gap-2">
      ...
      <div className="h-full flex flex-col p-2 sm:p-4 overflow-y-auto">
        {/* Header - Horizontal Layout */}
        <div className="flex items-center gap-2 mb-2 pb-2 border-b border-gray-200">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-purple-600 border-2 border-purple-500/30 flex items-center justify-center shrink-0 shadow-lg">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 text-gray-600">
              <span className="text-sm font-semibold">{profile.age} yrs</span>
              <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
              <span className="text-xs">{profile.gender}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-1.5 mb-1.5">
          {/* Height */}
          {profile.height && (
            <div className="bg-teal-50 border border-teal-200 rounded-lg p-1.5 sm:p-2 flex items-center gap-1.5 sm:gap-2">
              ...
              <div>
                <p className="text-[10px] text-gray-500 font-medium">Height</p>
                <p className="text-sm font-bold text-gray-800">{convertCmToFeetInches(profile.height)}</p>
              </div>
            </div>
          )}
          ...
          {/* Skin Tone */}
          {profile.skinTone && (
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-1.5 sm:p-2 flex items-center gap-1.5 sm:gap-2">
              ...
              <div>
                <p className="text-[10px] text-gray-500 font-medium">Skin</p>
                <p className="text-xs font-bold text-gray-800 truncate">{profile.skinTone}</p>
              </div>
            </div>
          )}
        </div>
        ...
        {profile.university && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-1.5 sm:p-2 mb-1.5 flex items-start gap-1.5 sm:gap-2">
            <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center shrink-0">
              <GraduationCap className="w-4 h-4 text-blue-600" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-[10px] text-gray-500 font-medium mb-0.5">Education</p>
              <p className="text-sm font-bold text-gray-800 truncate">{profile.university}</p>
        ...
        <div className="mt-auto pt-2 border-t border-gray-200">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-1.5">
            ...
            <button
              onClick={onSkip}
              className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl text-white transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center"
            ...
            <button
              ...
              className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl text-white transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center hover:brightness-110"
